...
register_toolchains("//:toolchain/debian", "//:toolchain/fedora", "//:toolchain/ubuntu")

# //:platform/* are constrained by //dist:* so we can register all of them
register_execution_platforms("//:platform/linux/debian", "//:platform/linux/fedora", "//:platform/linux/ubuntu")

...
bazel test --config debian "$@" -- //... -//rpm/... -//diy/...
bazel test --config fedora "$@" -- //... -//rpm/... -//diy/...
bazel test --config ubuntu "$@" -- //... -//rpm/... -//diy/...
...
bazel test --config rocky "$@" -- //... -//diy/...
bazel test --config centos "$@" -- //... -//diy/...
